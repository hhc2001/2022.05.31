...
var reg1 =  /^[1-9]\d*\.\d*|0\.\d*[1-9]\d*$/;
 ...
 var flag = 0;
 if(document.getElementById('kucunid').value.match(reg1) != null){
 	flag=1
 }
  if(document.getElementById('kucunid').value.match(reg2) != null){
 	flag=1
 }
...
<TABLE cellSpacing=1 borderColorDark=#ffffff cellPadding=0 align=center bgColor=#cccccc borderColorLight=#999999 border=0>
  <TBODY>
    ...
    <TR>
      ...
      <TD width=300 bgColor=#f6f6f6 height=20>
      <input  type="text" name="kucun"  id='kucunid'  size="40" />
      </TD>
