...
<TABLE cellSpacing=1 borderColorDark=#ffffff cellPadding=0 align=center bgColor=#cccccc borderColorLight=#999999 border=0>
  <TBODY>
    ...
    <TR>
      ...
      <TD width=300 bgColor=#f6f6f6 height=20>
      <input  type="text" name="gtitle"  id='gtitleid'  size="40" value="${bean.gtitle }" readonly="readonly" />
      </TD>
    ...
    <TR>
      ...
      <TD width=300 bgColor=#f6f6f6 height=20>
     <textarea rows="7" cols="50" name="gcontent" readonly="readonly">${bean.gcontent }</textarea>
      </TD>
