...
<input  onclick="javascript:window.location.href='<%=basePath %>${url2 }add.action';" class="buttoncss" type="button" value="添加公告" />
     &nbsp;&nbsp;&nbsp;
       公告标题：<input type="text"  name="gtitle" value="${gtitle }" /> 
...
<TABLE width="100%" cellSpacing=1 borderColorDark=#ffffff cellPadding=0 align=center bgColor=#cccccc borderColorLight=#999999 border=0>
  <TBODY>
    <TR>
      ...
      <TD align=middle  bgColor=#f6f6f6 height=20>公告标题</TD>
